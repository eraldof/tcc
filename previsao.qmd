...
treinamento2 <- training(splitted)

splitted <- initial_split(dados3, prop = 0.7, strata = "Y")
treinamento3 <- training(splitted)

splitted <- initial_split(dados4, prop = 0.7, strata = "Y")
treinamento4 <- training(splitted)

splitted <- initial_split(dados5, prop = 0.7, strata = "Y")
treinamento5 <- training(splitted)

splitted <- initial_split(dados6, prop = 0.7, strata = "Y")
treinamento6 <- training(splitted)
