...
dados2 <- dados %>% select("clr", "clf", "clv", "dmedia", "ddesvio","VL_DEV", "QT_DEV", "dcadastro","d1", "d2", "d3", "Y")
...
dados6 <- dados %>% select("rfv", "dmedia", "ddesvio", "dcadastro", "d1", "d2", "d3", "VL_DEV", "QT_DEV", "Y")
